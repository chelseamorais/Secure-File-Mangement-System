...
def cd(plaintext_filename,current_dir):
    ...
    if os.path.exists(filename):
        ...
        rest1 = os.getcwd().split('replica2')[1]
        rest2 = ""
...
if __name__ == "__main__":
    ...
    #print(writeperm_encrypted)
    with open(writeperm_encrypted,'a+') as f:
    #with open('C:\Users\chethan07\Desktop\CompSec\pcs\Replica2Permissions\WritePermissions.txt') as f:
        data = f.read()
        print(data)
        if data :
...
#file_dictionaryW=json.loads(data)
    ...
    # with open('C:\Users\chethan07\Desktop\CompSec\pcs\Replica2Permissions\ReadPermissions.txt') as f:
        data1 = f.read()
        print(data1)
        if data1 :
